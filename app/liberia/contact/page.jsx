  ...
  const services = [
    {
      ...
      description:
        "Decades of combined expertise guide every decision and every nail.",
    },
    {
      name: "Advanced equipment",
      img: "/liberia/contact/equipment.jpg",
      description:
        "Modern tools and proven methods ensure efficiency without compromising quality.",
    },
    {
      name: "On-time delivery",
      img: "/liberia/contact/delivery.jpg",
      description:
        "We respect your schedule. Projects finish when promised, not when convenient.",
    },
  ];
  ...
  const results = [
    {
      ...
      description:
        "A track record of successful projects across residential, commercial, and industrial sectors.",
    },
    {
      number: "95%",
      ...
      description:
        "15+ years of learning, improving, and earning trust one project at a time.",
    },
    {
      number: "99%",
  ...
  const questions = [
    {
      ...
      description:
        "Timeline depends on scope. A renovation might take 4-8 weeks. A custom home takes 6-12 months. We provide detailed schedules upfront.",
    ...
    },
    {
      ...
      description:
        'Yes. We manage all permits and inspections. That"s part of our job, not yours.',
    ...
    },
    {
      ...
      description:
        "We notify you immediately and explain the reason. No work proceeds without your approval on changes.",
    ...
    },
    {
      ...
      description:
        "All work is warranted for one year. Structural elements carry longer warranties based on building codes.",
      img: "/liberia/contact/timeline.jpg",
    ...
    },
    {
      ...
      description:
        'We"re flexible. We discuss your needs and find a schedule that works for both of us.',
      img: "/liberia/contact/permits.jpg",
    ...
    },
    {
      ...
      description:
        'Call or email us with your project details. We"ll schedule a free consultation to discuss scope and next steps.',
      img: "/liberia/contact/permits.jpg",
    ...
    <main>
      <section className=" hero-spacing ">
        <div className="flex flex-col gap-3 md:flex-1 items-start justify-start md:justify-center">
          <h1 className="heading  md:max-w-10/12">
            We build structures that lasts
          </h1>
          <p className="w-full md:w-3/4">
            Construction done right takes time, skill, and people who care.
            AdEss has been doing it for twenty years.
          </p>
        ...
        <div className="flex-1 overflow-hidden">
          <Image
            src={"/liberia/contact/hero-bg.jpg"}
            width={500}
            height={500}
            alt="Contact Us"
      ...
      <section className="spacing bg-primary text-white">
        <div className="text-center mb-16">
          ...
          <p className=" text-base leading-relaxed max-w-xl mx-auto">
            We've spent years perfecting our craft. Our reputation is earned
            through consistent delivery and honest work.
          </p>
        </div>
      ...
      <section className="spacing">
        <div className="text-center mb-16">
          ...
          <p className="text-primary/60 text-base leading-relaxed max-w-xl mx-auto">
            Our track record reflects years of consistent work and satisfied
            clients.
          </p>
        </div>
        ...
        <div className=" h-fit">
          ...
          <div className="flex  gap-6">
            {results.map((result, index) => (
              ...
              >
                <p className="text-4xl font-bold ">{result.number}</p>
      ...
      <section className="spacing bg-secondary">
        <div className="text-center mb-16">
          ...
          <p className="text-primary/60 text-base leading-relaxed max-w-xl mx-auto">
            Find answers to common questions about our process, timeline, and
            services.
          </p>
        </div>
        ...
        <div className="flex justify-center flex-col items-center gap-3 mt-10">
          <h2 className="font-roboto font-extrabold mb-2 text-xl">
            Need more help?
          </h2>
          <p className="text-center">
            Reach out directly and we"ll answer whatever you need to know
          </p>
          <button className="edge-button bg-transparent border text-black">
            Call
          </button>
        </div>
      </section>
      ...
      <section className="spacing">
        <div className="border flex h-fit gap-10 p-10 flex-col lg:flex-row">
          <div className="flex-1">
            ...
            <div>
              <SendEmail formData={formData} setFormData={setFormData}/>
            </div>

            <p className="text-xs mt-5 ">
              We respect your privacy and we will only use your information to
              discuss your project.
            </p>
          </div>
          <div className="overflow-hidden w-full flex-1">
            <Image
              src="/liberia/contact/contact-cta.jpg"
              alt="Get Started"
              width={500}
              height={500}
              className="w-full! h-full object-cover "
